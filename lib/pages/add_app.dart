...
import 'package:CryptApps/components/custom_app_bar.dart';
...
import 'package:CryptApps/pages/app.dart';
import 'package:CryptApps/pages/import_export.dart';
import 'package:CryptApps/pages/settings.dart';
import 'package:CryptApps/providers/apps_provider.dart';
  ...
  Widget build(BuildContext context) {
    ...
    runSearch() async {
      ...
      try {
        ...
        if (res.isEmpty) {
          throw CryptAppsError(tr('noResults'));
        }
