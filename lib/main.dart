...
import 'package:CryptApps/pages/home.dart';
...
void main() async {
  ...
  runApp(MultiProvider(
    ...
    child: EasyLocalization(
        ...
        fallbackLocale: fallbackLocale,
        useOnlyLangCode: true,
        child: const CryptApps()),
  ));
}

var defaultThemeColour = Colors.deepPurple;

class CryptApps extends StatefulWidget {
  const CryptApps({super.key});

  @override
  State<CryptApps> createState() => _CryptAppsState();
}

class _CryptAppsState extends State<CryptApps> {
  ...
  Widget build(BuildContext context) {
    ...
    if (settingsProvider.prefs == null) {
      ...
      if (isFirstRun) {
        logs.add('This is the first ever run of CryptApps.');
        // If this is the first run, ask for notification permissions and add CryptApps to the Apps list
        Permission.notification.request();
        appsProvider.saveApps([
          App(
              CryptAppsId,
              'https://github.com/CryptAdmin/CryptApps',
              'CryptAdmin',
              'CryptApps',
              currentReleaseTag,
              currentReleaseTag,
