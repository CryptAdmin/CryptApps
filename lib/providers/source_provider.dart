...
import 'package:CryptApps/app_sources/apkmirror.dart';
import 'package:CryptApps/app_sources/apkpure.dart';
import 'package:CryptApps/app_sources/aptoide.dart';
import 'package:CryptApps/app_sources/codeberg.dart';
import 'package:CryptApps/app_sources/fdroid.dart';
import 'package:CryptApps/app_sources/fdroidrepo.dart';
import 'package:CryptApps/app_sources/github.dart';
import 'package:CryptApps/app_sources/gitlab.dart';
import 'package:CryptApps/app_sources/huaweiappgallery.dart';
import 'package:CryptApps/app_sources/izzyondroid.dart';
import 'package:CryptApps/app_sources/html.dart';
import 'package:CryptApps/app_sources/jenkins.dart';
import 'package:CryptApps/app_sources/mullvad.dart';
import 'package:CryptApps/app_sources/neutroncode.dart';
import 'package:CryptApps/app_sources/signal.dart';
import 'package:CryptApps/app_sources/sourceforge.dart';
import 'package:CryptApps/app_sources/sourcehut.dart';
import 'package:CryptApps/app_sources/steammobile.dart';
import 'package:CryptApps/app_sources/telegramapp.dart';
import 'package:CryptApps/app_sources/uptodown.dart';
import 'package:CryptApps/app_sources/vlc.dart';
import 'package:CryptApps/app_sources/whatsapp.dart';
import 'package:CryptApps/components/generated_form.dart';
import 'package:CryptApps/custom_errors.dart';
import 'package:CryptApps/mass_app_sources/githubstars.dart';
import 'package:CryptApps/providers/settings_provider.dart';
...
// App JSON schema has changed multiple times over the many versions of CryptApps
...
CryptAppsError getCryptAppsHttpError(Response res) {
  return CryptAppsError((res.reasonPhrase != null &&
    ...
    for (var url in urls) {
      try {
        if (alreadyAddedUrls.contains(url)) {
          throw CryptAppsError(tr('appAlreadyAdded'));
        }
