...
String CryptAppsTempId = 'cryptAdmin_cryptApps_${GitHub().host}';
String CryptAppsId = 'dev.cryptAdmin.cryptApps';
...
class SettingsProvider with ChangeNotifier {
  ...
  String sourceUrl = 'https://github.com/CryptAdmin/CryptApps';
